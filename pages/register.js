...
export default function Home() {
  ...
  function login() {
    fetch("/api/auth/register", {
      ...
      if (r.code === 1002) Router.push("/login")
    })
  }
  return (
    <>
        ...
        <main>
          <div className='w-screen bg-blue-500 h-screen flex flex-col items-center justify-center authbg'>
            <div className='flex flex-col justify-center bg-gray-200 p-5 rounded-xl'>
              ...
              <div className="flex flex-col bg-gray-300 p-4 space-x-4 rounded-lg mb-3">
                Password
                <input className="bg-gray-400 outline-none rounded-lg px-2" type="text" placeholder="Provider" />
              </div>
              <div className="flex flex-col bg-gray-300 p-4 space-x-4 rounded-lg mb-3">
                Confirm Password
              ...
              <div onClick={() => register()} className="bg-blue-500 hover:bg-blue-400 p-3 rounded-lg text-center text-white text-2xl font-semibold">
                Register
              </div>
